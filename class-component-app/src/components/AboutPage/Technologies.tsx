    ...
    <div className={styles.container}>
      <div className={styles.infoText}>
        ...
        <p>
          ...
          is efficiently managed using Redux and RTK Query for state management
          and data fetching. Everything runs smoothly thanks to Vite, which
          helps the app load and build really fast.
        </p>
      </div>
      {!isMobile && (
        <img
